...
class FightsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create fight" do
    assert_difference('Fight.count') do
      post fights_url, params: { fight: { attacker: @fight.attacker, date: @fight.date, defender: @fight.defender, gold: @fight.gold, winner: @fight.winner } }
    end
  ...
  test "should update fight" do
    patch fight_url(@fight), params: { fight: { attacker: @fight.attacker, date: @fight.date, defender: @fight.defender, gold: @fight.gold, winner: @fight.winner } }
